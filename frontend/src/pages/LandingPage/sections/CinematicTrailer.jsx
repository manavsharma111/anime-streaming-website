...
export default function CinematicTrailer() {
  ...
  return (
    <section
      ref={containerRef}
      className="relative w-full h-[150vh] bg-[#050505] flex items-center justify-center"
    >
        ...
        >
          ...
          >
            ...
            <p className="text-white/60 text-lg md:text-2xl max-w-lg font-medium">
              Dive into the most stunning cinematic anime moments curated
              exclusively for you. No compromises.
            </p>
          </motion.div>
        </motion.div>
      </div>
