  ...
  return (
    ...
    >
      <div className="container mx-auto px-6 md:px-12 flex flex-col lg:flex-row items-center gap-12 md:gap-16">
        ...
        <div className="flex-1 relative h-[650px] lg:h-[600px] w-full flex items-center justify-center mt-20 lg:mt-0">
          ...
          <motion.div
            style={isMobile ? {} : { y: y3 }}
            className="absolute z-30 left-0 md:left-20 lg:left-1/4 bottom-12 lg:bottom-10"
          >
