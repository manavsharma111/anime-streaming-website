        ...
        <main className="flex-1 min-w-0 flex flex-col gap-10">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-4">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-1 group cursor-pointer w-fit hover:text-white text-neutral-300 transition-colors" onClick={() => navigate('/search?sort=latest')}>
                <h3 className="font-black text-sm tracking-widest uppercase">NEW RELEASE</h3>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-1 group cursor-pointer w-fit hover:text-white text-neutral-300 transition-colors" onClick={() => navigate('/search?sort=latest')}>
                <h3 className="font-black text-sm tracking-widest uppercase">NEW ADDED</h3>
                <ChevronRight size={16} className="text-neutral-500 group-hover:text-white transition-colors" />
              </div>
              <div className="flex flex-col gap-2">
            ...
            {/* Just Completed */}
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-1 group cursor-pointer w-fit hover:text-white text-neutral-300 transition-colors" onClick={() => navigate('/search?status=Completed')}>
                <h3 className="font-black text-sm tracking-widest uppercase">JUST COMPLETED</h3>
                <ChevronRight size={16} className="text-neutral-500 group-hover:text-white transition-colors" />
              </div>
              <div className="flex flex-col gap-2">
