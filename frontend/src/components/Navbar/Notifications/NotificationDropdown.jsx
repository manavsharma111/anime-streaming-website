...
import { fetchNotifications, markNotificationReadAsync, deleteNotificationAsync } from '../../../redux/Slice/authSlice';
              ...
              <div className="flex flex-col">
                {notifications.map((notif) => (
                  ...
                  >
                    ...
                    <div className={`mt-1 rounded-full p-1.5 ${notif.read ? 'bg-neutral-800 text-neutral-400' : 'bg-[#f33767] text-white'}`}>
                      <Bell size={14} />
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className={`text-sm ${notif.read ? 'text-neutral-300' : 'text-white font-semibold'}`}>
                        {notif.message}
                      </p>
