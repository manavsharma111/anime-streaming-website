          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              <div className="flex justify-between items-center mb-6">
                ...
                <button onClick={() => setEditingEpisode(null)} className="text-neutral-400 hover:text-white">
                  <X size={20} />
                </button>
              </div>
              ...
              <form onSubmit={handleUpdate} className="flex flex-col gap-4">
                <div className="flex gap-4">
                  <div className="flex-1">
                    ...
                    <input 
                      ...
                      className="w-full bg-neutral-950 border border-neutral-800 rounded-lg p-2.5 text-sm text-white"
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-4 mt-2">
                  ...
                  <div>
                    ...
                    <input type="number" step="1" value={formData.introStart} onChange={(e) => setFormData({...formData, introStart: Number(e.target.value)})} className="w-full bg-neutral-950 border border-neutral-800 rounded-lg p-2 text-sm text-white" />
                  </div>
                  <div>
                    <label className="block text-[10px] uppercase font-bold text-neutral-500 mb-1">End Time</label>
                    <input type="number" step="1" value={formData.introEnd} onChange={(e) => setFormData({...formData, introEnd: Number(e.target.value)})} className="w-full bg-neutral-950 border border-neutral-800 rounded-lg p-2 text-sm text-white" />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-4 mt-2">
                  ...
                  <div>
                    <label className="block text-[10px] uppercase font-bold text-neutral-500 mb-1">Start Time</label>
                    <input type="number" step="1" value={formData.outroStart} onChange={(e) => setFormData({...formData, outroStart: Number(e.target.value)})} className="w-full bg-neutral-950 border border-neutral-800 rounded-lg p-2 text-sm text-white" />
                  </div>
                  <div>
                    <label className="block text-[10px] uppercase font-bold text-neutral-500 mb-1">End Time</label>
                    <input type="number" step="1" value={formData.outroEnd} onChange={(e) => setFormData({...formData, outroEnd: Number(e.target.value)})} className="w-full bg-neutral-950 border border-neutral-800 rounded-lg p-2 text-sm text-white" />
                  </div>
                </div>

                <button type="submit" className="mt-4 w-full bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-3 rounded-xl transition-colors flex items-center justify-center gap-2">
