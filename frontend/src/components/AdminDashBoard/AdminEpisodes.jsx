  ...
  const handleUpdate = async (e) => {
    ...
    try {
      await axiosInstance.put(
        `/anime-admin/episode/${editingEpisode._id}`,
        formData,
      )
        ...
        <div className="overflow-hidden rounded-2xl border border-white/5 bg-black/20">
          <div className="w-full">
            ...
            <div className="hidden md:grid grid-cols-[120px_1fr_120px_160px_160px] bg-neutral-900/50 border-b border-white/5">
              <div className="p-5 text-xs font-bold text-neutral-500 uppercase tracking-wider">
                Thumb
              </div>
              <div className="p-5 text-xs font-bold text-neutral-500 uppercase tracking-wider">
                Details
              </div>
              <div className="p-5 text-xs font-bold text-neutral-500 uppercase tracking-wider text-center">
                Status
              </div>
              <div className="p-5 text-xs font-bold text-neutral-500 uppercase tracking-wider text-center">
                Skips (s)
            ...
            <div className="divide-y divide-white/5">
              {loading ? (
                ...
                episodes.map((ep) => (
                  <div
                    key={ep._id}
                    className="flex flex-col md:grid md:grid-cols-[120px_1fr_120px_160px_160px] items-center hover:bg-white/[0.02] transition-colors p-4 md:p-0 gap-4 md:gap-0"
                  >
                    {/* Thumbnail */}
                    <div className="md:p-5 w-full md:w-auto flex justify-center md:justify-start">
                      <div className="relative overflow-hidden rounded-lg shadow-lg w-full max-w-[200px] md:w-24 h-32 md:h-16 bg-neutral-950">
                        {ep.thumbnailUrl ? (
                          <img
                            src={getImageUrl(ep.thumbnailUrl)}
                            alt="thumb"
                    ...
                    <div className="md:p-5 text-center w-full md:w-auto flex justify-between md:justify-center items-center border-t border-white/5 md:border-0 pt-3 md:pt-0">
                      ...
                      <span
                        className={`inline-flex items-center px-2 py-1 rounded text-[10px] font-black uppercase tracking-widest ${
                          ep.status === "ready"
                ...
                >
                  ...
                  <div className="p-6 overflow-y-auto custom-scrollbar bg-neutral-900 flex-1">
                    ...
                    >
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                introStart: Number(e.target.value),
                              })
                            }
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                introEnd: Number(e.target.value),
                              })
                            }
                            className="w-full bg-neutral-950 border border-neutral-800 rounded-lg p-2.5 text-sm text-white"
                          />
                      ...
                      <div className="grid grid-cols-2 gap-4 border-t border-white/5 pt-4 mt-2">
                        ...
                        <div>
                          ...
                          <input
                            type="number"
                            step="1"
                            value={formData.outroStart}
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                outroStart: Number(e.target.value),
                              })
                            }
                            className="w-full bg-neutral-950 border border-neutral-800 rounded-lg p-2.5 text-sm text-white"
                          />
                        ...
                        <div>
                          ...
                          <input
                            type="number"
                            step="1"
                            value={formData.outroEnd}
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                                outroEnd: Number(e.target.value),
                              })
                            }
                            className="w-full bg-neutral-950 border border-neutral-800 rounded-lg p-2.5 text-sm text-white"
                          />
                      ...
                      <button
                        type="submit"
                        className="mt-4 w-full bg-indigo-500 hover:bg-indigo-600 text-white font-bold py-3.5 rounded-xl transition-colors flex items-center justify-center gap-2"
                      >
