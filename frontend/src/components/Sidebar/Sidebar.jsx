...
import { Home, TrendingUp, PlaySquare, Film, List, Calendar, History, Bookmark } from 'lucide-react';
  ...
  return (
    <aside className="w-64 flex-shrink-0 hidden lg:block overflow-y-auto custom-scrollbar sticky top-[100px] max-h-[calc(100vh-120px)] bg-[#111111] rounded-2xl border border-neutral-800 shadow-xl p-4">
      ...
      <div className="flex flex-col gap-1 mb-6">
        <h3 className="text-[10px] uppercase font-bold text-neutral-500 tracking-wider mb-2 px-3">Menu</h3>
      ...
      <div className="flex flex-col gap-1">
        <h3 className="text-[10px] uppercase font-bold text-neutral-500 tracking-wider mb-2 px-3">Top Franchises</h3>
