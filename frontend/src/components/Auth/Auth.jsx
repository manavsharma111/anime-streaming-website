    ...
    return (
      <div className="flex flex-col p-2">
        <div className="flex items-center gap-3 mb-5 mt-2 px-2">
          {user.avatar ? (
            <img src={user.avatar} alt="Profile" className="w-10 h-10 rounded-full border border-neutral-700 shadow-md" />
          ) : (
          ...
          <div className="flex flex-col overflow-hidden">
            <h3 className="text-white font-bold text-[15px] truncate">{user.name || 'User'}</h3>
  ...
  return (
    <div className="flex flex-col p-2">
      <div className="text-center mb-6 mt-2">
        ...
        <p className="text-xs text-neutral-400 mt-1.5 font-medium">Sign in to sync your watchlist & history</p>
      </div>
