...
export const useKeyboard = (videoRef, handlers) => {
  const { togglePlay, toggleFullscreen, toggleMute, changeVolume, changePlaybackSpeed } = handlers;
  ...
  }, [videoRef, togglePlay, toggleFullscreen, toggleMute, changeVolume, changePlaybackSpeed]);
};
