...
export const fetchNotifications = createAsyncThunk('auth/fetchNotifications', async (_, { rejectWithValue }) => {
    try {
...
export const markNotificationReadAsync = createAsyncThunk('auth/markNotificationRead', async (id, { rejectWithValue }) => {
    try {
...
export const deleteNotificationAsync = createAsyncThunk('auth/deleteNotification', async (id, { rejectWithValue }) => {
    try {
