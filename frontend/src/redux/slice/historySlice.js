...
export const getWatchHistory = createAsyncThunk("history/getWatchHistory", async (_, { rejectWithValue }) => {
    try {
...
export const addToHistory = createAsyncThunk("history/addToHistory", async (data, { rejectWithValue }) => {
    try {
...
export const deleteAllHistory = createAsyncThunk("history/deleteAllHistory", async (_, { rejectWithValue }) => {
    try {
        const response = await historyService.deleteAllHistory()
        return response.data
    } catch (error) {
        return rejectWithValue(error.response?.data || "Failed to delete all history")
    }
})
