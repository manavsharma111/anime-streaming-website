...
router.post("/create", admin, adminUpload.fields([{ name: "thumbnail", maxCount: 1 }, { name: "cover", maxCount: 1 }]), createAnime);
router.put("/:id", admin, adminUpload.fields([{ name: "thumbnail", maxCount: 1 }, { name: "cover", maxCount: 1 }]), updateAnime);
